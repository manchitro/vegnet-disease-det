...
def evaluate(
    ...
    for label in range(generator.num_classes()):
        ...
        print("TP: ", true_positives[-1] if len(true_positives) > 0 else 'N/A')
        print("FP: ", false_positives[-1] if len(false_positives) > 0 else 'N/A')
        ...
        with open(csv_file_path, 'a', newline='') as file:
            ...
            writer.writerow([
                epoch, 
                label_name, 
                true_positives[-1] if len(true_positives) > 0 else 'N/A', 
                false_positives[-1] if len(false_positives) > 0 else 'N/A', 
                average_precisions[label][0], 
                precision[-1] if len(precision) > 0 else 'N/A', 
